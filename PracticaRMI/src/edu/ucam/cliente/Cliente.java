                ...
                try {
                    ...
                    switch (opcion) {
                        ...
                        case 4: 
                            ...
                            System.out.print("ID: "); 
                            String idTB = sc.nextLine();
                            
                            if (gestion.removeTitulacion(idTB)) {
                        ...
                        case 9:
                            ...
                            if (gestion.removeAsignatura(idAB)) {
                        ...
                        case 11:
                            ...
                            System.out.print("ID Asignatura: "); 
                            String idAsigD = sc.nextLine();
                            System.out.print("ID Título: "); 
                            String idTitD = sc.nextLine();
                        ...
                        case 12:
                            ...
                            System.out.print("ID Título: "); 
                            String idTV = sc.nextLine();
                            
                            List<Asignatura> lRel = gestion.listAsignaturasDeTitulo(idTV);
                            
                            if (lRel.isEmpty()) {
                                System.out.println("No tiene asignaturas o el título no existe.");
                            }
                            
                            for (Asignatura as : lRel) {
                        ...
                        case 14:
                            ...
                            System.out.print("ID Matrícula a modificar: "); 
                            String idMM = sc.nextLine();
                        ...
                        case 15: 
                            ...
                            System.out.print("ID: "); 
                            String idMC = sc.nextLine();
                            
                            Matricula mc = gestion.getMatricula(idMC);
                            
                            if (mc != null) {
                                System.out.println("Encontrada: ID " + mc.getId());
                            } else {
                        ...
                        case 16:
                            ...
                            System.out.print("ID: "); 
                            String idMB = sc.nextLine();
                            
                            if (gestion.removeMatricula(idMB)) {
                                System.out.println("Eliminada.");
                            } else {
                                System.out.println("No encontrada.");
                            }
